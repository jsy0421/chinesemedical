		...
		<view class="tui-form">
			<view class="tui-view-input">
				...
				<tui-list-cell :hover="false" :lineLeft="false" backgroundColor="transparent">
					<view class="tui-cell-input">
						...
						<input :value="password" placeholder="请输入新密码" :password="true" placeholder-class="tui-phcolor"
			...
			<view class="tui-btn-box">
				<tui-button :disabledGray="true" :disabled="disabled" :shadow="true" shape="circle"
					@click="forgetPwd()">确认修改</tui-button>
			</view>
		...
		methods: {
			...
			forgetPwd: function() {
				...
				if (_this.mobile.length != 11) {
					...
					uni.request({
						url: 'http://192.168.43.90:3333/forgetPwd',
						data: {
